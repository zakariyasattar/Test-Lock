...
var stopEnter = false,
    canCount = false,
    canChangeCircle = true;
var key = initKey();
var timer = 0;

(function () {
  // Expose to global
  var leaverCount = 0; //code to call when document leaves full screen
...
window.onload = function () {
  $("#create-exam").on('change', "input:radio", function () {
    if (parseInt(this.name.substring(0, 1))) {
      //MC
...
function getStudent(id) {
  students = mergeSort(students); //binary search for finding ID pos
...
function populateExam(code, ref) {
  ...
  setTimeout(function () {
    ...
    var exam = document.getElementById('exam'); //convert HTMLcollection to array and shuffle
...
function createFreeResponse() {
  var ta = document.createElement('textarea'); // read when user changes text area
...
},{}]},{},["../.nvm/versions/node/v13.0.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","assets/js/index.js"], null)
